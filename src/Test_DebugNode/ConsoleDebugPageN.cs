...
{
    public class ConsoleDebugPageN : ConsoleDebugPage
    {
        ...
        public ConsoleDebugPageN(ConfigurationBT<ConsoleDebugModule> config, int id, string name)
        : base(config, id, name)
        {
            root = BehaviorTree.IfElse<ConsoleDebugModule>(config, -1, "ConsoleDebugPageN");
        }
